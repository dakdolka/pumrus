...
function BrandLogo() {
  return (
    <svg className="brand-logo" viewBox="0 0 320 96" aria-label="UmRus" role="img">
      ...
      <g className="brand-cap" fill="none" strokeLinecap="round" strokeLinejoin="round">
        <path d="M8 23 39 10l30 14-32 13L8 23Z" strokeWidth="3" />
        <path d="M22 31v8c8 4 21 4 29 0v-8" strokeWidth="3" />
        <path d="M9 24 5 43" strokeWidth="2.5" />
        <path d="m5 43-3 8m3-8 3 8" strokeWidth="2.5" />
      </g>
      <text x="98" y="81" fontSize="55" fontWeight="800" letterSpacing="-2">mRus</text>
    </svg>
  );
}
